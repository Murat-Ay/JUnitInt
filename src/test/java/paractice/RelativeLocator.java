...
//      mexicoLinkTest => Linkin goruntulenip goruntulenmedigini dogrulayin
    ...
    public void logoTesti(){
        ...
        WebElement bestBuyLogo = driver.findElement( org.openqa.selenium.support.locators.RelativeLocator.with(By.tagName("img")).above(helloHeading));
    ...
    public void linkTesti(){
        ...
        WebElement mexicoFlag = driver.findElement( org.openqa.selenium.support.locators.RelativeLocator.with(By.tagName("img")).toRightOf(usFlag));
